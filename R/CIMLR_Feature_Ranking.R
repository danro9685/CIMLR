...
#' 
#' @param A an (n x n) similarity matrix by CIMLR
#' @param X a set of multi-omic data inputs each of which is an (m x n) data matrix of measurements of cancer patients appended by rows
#'
#' @return a list of 2 elements: pvalues and ranking ordering over the n covariates 
#' as estimated by the method
#' 
#' @export CIMLR_Feature_Ranking
#'
"CIMLR_Feature_Ranking" <- function( A, X ) {
