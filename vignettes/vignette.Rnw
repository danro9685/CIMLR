...
\affil[3]{Dipartimento di Informatica Sistemistica e Comunicazione, Università degli Studi di Milano-Bicocca, Milano, Italy.}
...
CIMLR & Cancer Integration via Multikernel Learning & \href{https://www.biorxiv.org/content/early/2018/10/14/267245}{Publication}\\ \hline
...
\end{center}
\caption{Visualization of the 5 clusters retrieved by CIMLR on the dataset GliomasReduced.}
\end{figure*}
